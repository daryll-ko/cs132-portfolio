        ...
        <div className="lg:max-w-[60%]">
          <div>
            ...
            <p className="mb-8 text-center text-sm leading-6 text-gray-500 sm:text-base">
              ...
              obcaecati qui, iste nobis exercitationem deserunt magnam
              asperiores voluptatum sit, molestiae, facere maiores eius id odio
              ullam illum minima consequuntur quae ipsam soluta quibusdam! Eum
              dolor sed blanditiis optio deleniti quos vel quasi? Vitae minima
              reprehenderit deserunt veritatis.
            </p>
          </div>
